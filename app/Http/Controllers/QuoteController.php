...
class QuoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (empty($request->tags))
            return redirect(route('quotes.create'))->withInput($request->input())->with('tag_error', 'Tag Tidak Boleh Kosong');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('quotes')->with('msg', 'Kutipan berhasi diedit');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('quotes')->with('msg', 'Kutipan berhasl didelete.');
    }
}
